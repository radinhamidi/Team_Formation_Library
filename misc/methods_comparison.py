...
plt.plot(k_set, y_t2v_dim2000_members, label='Team2Vec - Dim2000 - Member Similarity')
plt.plot(k_set, y_t2v_dim1500_members, label='Team2Vec - Dim1500 - Member Similarity')
plt.plot(k_set, y_t2v_dim1000_members, label='Team2Vec - Dim1000 - Member Similarity')
...
plt.plot(k_set, y_t2v_dim100_members, label='Team2Vec - Dim100 - Member Similarity')
