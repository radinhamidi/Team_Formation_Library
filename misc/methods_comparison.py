...
with open('./Baseline_mapk_50.pkl', 'rb') as f:
    BL_mapk = pkl.load(f)
...
y_bl_mapk = [BL_mapk[k] for k in k_set]
y_bl_2017 = [BL_2017_r_at_k[k] for k in k_set]
...
plt.plot(k_set, y_t2v_skill_dim500, 'b--', label='Team2Vec-Skill - VAE')
# plt.plot(k_set, y_t2v_skill_VAE_hybrid, label='T2V-Skill-VAE-Hybrid')
plt.plot(k_set, y_bl, label='Baseline Method 2009')
plt.plot(k_set, y_bl_2017, label='Baseline Method 20017')
plt.legend(loc='best')
plt.grid()
...
# plt.plot(k_set, y_t2v_skill_VAE_hybrid, label='T2V-Skill-VAE-Hybrid')
plt.plot(k_set, y_bl_mapk, label='Baseline Method 2009')
plt.plot(k_set, y_bl_2017_mapk, label='Baseline Method 20017')
plt.legend(loc='best')
plt.grid()
